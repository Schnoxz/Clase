...
//Clase principal que contiene el método main y orquesta el combate Pokémon
public class Main {
 ...
 public static void main(String[] args) {
     ...
     // Posición 0: AtaqueDanio "Lanzallamas", tipo FUEGO, cuesta 40 de energía, hace 90 de daño
     ataques[0] = new AtaqueDaño("Lanzallamas", 40, TipoElemento.FUEGO, 90);
     // Posición 1: AtaqueCuracion "Respiro", tipo VOLADOR, cuesta 50 de energía, cura 100 PS
     ataques[1] = new AtaqueCuracion("Respiro", 50, TipoElemento.VOLADOR, 100);
     // Posición 2: AtaqueDanio "Llamarada", tipo FUEGO, cuesta 80 de energía, hace 150 de daño
     // Este ataque fallará porque tras usar los dos anteriores (40+50=90), solo quedan 10 de energía
     ataques[2] = new AtaqueDaño("Llamarada", 80, TipoElemento.FUEGO, 150);
     ...
     for (Ataque ataque : ataques) {
         ...
         // Mostramos qué movimiento se va a intentar usar usando el toString() del ataque
         ...
         try {
             ...
             // Si el ataque se ejecutó sin excepción, mostramos la energía restante de Charizard
