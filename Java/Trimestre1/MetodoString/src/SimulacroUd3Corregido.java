    ...
    public static void main(String[] args) {
        ...
        while (continuar) {
            ...
            switch (usuarioOpcion) {
                case 1 ->
                    System.out.println("Número de espacios: " + numEspaciados(frase));
                case 2 ->
                    System.out.println("Número de palabras: " + numPalabras(frase));
                case 3 ->
                    System.out.println("Cuántas mayúsculas tiene la ultima palabra: " + numMayus(frase));
                case 4 ->
